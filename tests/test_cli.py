...
from scixtract.cli import (
    extract_command, knowledge_command, save_results, 
    generate_markdown, main
)
from scixtract.models import DocumentMetadata, PageContent, ExtractionResult
...
class TestSaveResults:
    ...
    def test_save_results(self):
        ...
        pages = [
            PageContent(page_num=1, raw_text="Test content", processed_text="Processed test content")
        ]
...
class TestExtractCommand:
    ...
    @patch('scixtract.cli.save_results')
    def test_extract_command_with_knowledge_update(self, mock_save_results, mock_tracker_class, mock_processor_class):
...
class TestMainCLI:
    ...
    def test_main_extract_command(self, mock_extract):
        ...
        test_args = [
            'ai-pdf-extract', 'extract', 'test.pdf', 
            '--model', 'test-model'
        ]
