    ...
    def __init__(self):
        ...
        self.recommended_models = {
            ...
            "qwen2.5:32b-instruct-q4_K_M": {
                ...
                "strengths": ["Perfect JSON", "Academic analysis", "Keyword extraction"],
                "recommended": True
            },
            "qwen2:72b": {
                "size": "40GB", 
                "description": "Large model with superior reasoning",
                "strengths": ["Complex reasoning", "High accuracy", "Detailed analysis"],
                "recommended": False
            },
            "mistral": {
                "size": "4.1GB",
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if "keywords" in parsed and isinstance(parsed["keywords"], list):
                        ...
                        print(f"⚠ Model {model_name} works but output format needs improvement")
                        return True
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Setup Ollama for PDF processing"
    )
    parser.add_argument(
        "--model", 
        help="Specific model to install (default: auto-recommend)"
    )
    parser.add_argument(
